...
public class UIGlobals
{
	...
	public const string ROUTE_BASE = "/azure";
	public const string ROUTE_HOME = $"{ROUTE_BASE}/";
	public const string ROUTE_CATCHALL = ROUTE_BASE + "/{*route:nonfile}";

	/*----------------------------------------------------------------------*/

	public const string ROUTE_AZURE_REGIONS = $"{ROUTE_BASE}/regions";
	public const string ROUTE_AZURE_SKUS = $"{ROUTE_BASE}/skus";
	public const string ROUTE_AZURE_PRICING = $"{ROUTE_BASE}/pricing";
